...
T_gc=40
P_gc=100
T_eva=-16 #al minimo -20.725759899810726
T_EVA_AT=0#7
eta_c=0.8
eta1=0.9
eta2=0.8
...
def f_T_EVA_AT(y):
    ...
    f[0]=(T[9]-(dT*xx+T_freddo+T_ref))
    f[1]=(T[7]-(dT*xx+T_freddo+T_ref))
...
plt.plot((0,(H[0]-H[9]+(H[7]-H[6])*m[2])/1000),(T_freddo,T_freddo+dT),'r')
