...
from mixture_impianto_senza_eiettore_IHX_function import Funz
...
fluid2.append("CO2"); x0.append(1)  #cop=2.25
...
def process(P_gcc):
    funz=Funz(eps,P_gcc,T_gc,T_eva,eta_c,mix,mix_l,mix_g)
...
def process7(P_gcc):
    funz=Funz(eps,P_gcc,T_gc,T_eva-glide,eta_c,mix,mix_l,mix_g)
